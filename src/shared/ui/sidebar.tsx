...
import { Button, typographyVariants } from "@shared/ui";
...
const SidebarTrigger = ({ className, onClick, ...props }: React.ComponentProps<typeof Button>) => {
  ...
  return (
    <Button
      ...
      variant='ghost'
      size='icon'
      className={cn("absolute top-6 left-2", className)}
      onClick={(event: any) => {
        onClick?.(event);
        toggleSidebar();
      }}
...
const SidebarHeader = ({ className, ...props }: React.ComponentProps<"div">) => (
  <div
    ...
    data-sidebar='header'
    className={cn("flex flex-col gap-2 pt-3", className)}
    {...props}
  />
);
...
const SidebarContent = ({ className, ...props }: React.ComponentProps<"div">) => (
  <div
    ...
    className={cn(
      "flex min-h-0 flex-1 flex-col gap-2 overflow-auto pb-5 group-data-[collapsible=icon]:overflow-hidden",
      className
    )}
    {...props}
  />
...
const SidebarGroupContent = ({ className, ...props }: React.ComponentProps<"div">) => (
  <div
    ...
    className={cn("w-full", typographyVariants({ variant: "paragraph_14_regular" }), className)}
    {...props}
  />
);
